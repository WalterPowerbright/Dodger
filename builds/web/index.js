...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/dodger_master.png", "start": 0, "end": 9408}], "remote_package_size": 9408});

  })();

// end include: /tmp/tmp58bn43gd.js
// include: /tmp/tmpoh7abnue.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpoh7abnue.js
// include: /tmp/tmpobxsofi7.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpobxsofi7.js
...
var ASM_CONSTS = {
  96760: () => { if (document.fullscreenElement) return 1; },  
 96806: () => { return Module.canvas.width; },  
 96838: () => { return parseInt(Module.canvas.style.width); },  
 ...
 97032: () => { return Module.canvas.width; },  
 97064: () => { return screen.width; },  
 97089: () => { document.exitFullscreen(); },  
 97116: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97249: () => { return window.innerWidth; },  
 97275: () => { return window.innerHeight; },  
 97302: () => { if (document.fullscreenElement) return 1; },  
 97348: () => { return Module.canvas.width; },  
 97380: () => { return parseInt(Module.canvas.style.width); },  
 97428: () => { if (document.fullscreenElement) return 1; },  
 97474: () => { return Module.canvas.width; },  
 97506: () => { return screen.width; },  
 97531: () => { return window.innerWidth; },  
 97557: () => { return window.innerHeight; },  
 97584: () => { if (document.fullscreenElement) return 1; },  
 97630: () => { return Module.canvas.width; },  
 97662: () => { return screen.width; },  
 97687: () => { document.exitFullscreen(); },  
 97714: () => { if (document.fullscreenElement) return 1; },  
 97760: () => { return Module.canvas.width; },  
 97792: () => { return parseInt(Module.canvas.style.width); },  
 97840: () => { document.exitFullscreen(); },  
 97867: ($0) => { Module.canvas.style.opacity = $0; },  
 97905: () => { return screen.width; },  
 97930: () => { return screen.height; },  
 97956: () => { return window.screenX; },  
 97983: () => { return window.screenY; },  
 98010: () => { return window.devicePixelRatio; },  
 98046: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98099: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 98150: () => { Module.canvas.style.cursor = 'none'; },  
 98187: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98443: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 98494: () => { if (document.fullscreenElement) return 1; },  
 98540: () => { return window.innerWidth; },  
 98566: () => { return window.innerHeight; },  
 98593: () => { if (document.pointerLockElement) return 1; }
};
